...
function Like(postId) {
    $.ajax({
        type: "POST",
        url: "PostAction/Like?postId=" + postId,
        success: function (json) {
            var postInfoid = "#post_likes" + postId;
            var postLikeId = "#LikeImage" + postId;
            var postLikedId = "#LikedImage" + postId;
            var postLikesCountId = "#PostLikesCount" + postId;
            ...
            $(postLikesCountId).text(json.count);

            if (json.liked === true) {
                $(postLikeId).attr("hidden", true);
                $(postLikedId).removeAttr("hidden");
            } else {
                $(postLikeId).removeAttr("hidden");
                $(postLikedId).attr("hidden", true);
...
function addComment(postId) {
    var commentFieldId = "#commentField" + postId;
    var commentText = $(commentFieldId).val();
    commentText = decodeURIComponent(commentText);
